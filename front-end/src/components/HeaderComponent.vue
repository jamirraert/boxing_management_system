    ...
    <Menubar :model="items">
        ...
        <template #end>
            <div class="relative">
                ...
                <ul class="list-none m-0 absolute right-1 bg-white rounded p-3 box-border shadow transition-all duration-300 ease-in-out"
                :class="!isDropdownVisible ? 'hidden' : 'visible'">
                    <li
